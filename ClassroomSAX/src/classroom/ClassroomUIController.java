...
public class ClassroomUIController implements Initializable {
    ...
    private void handleOpen(ActionEvent event) {
        ...
        if (file != null) {
            try
            {
                Input doc = CourseXMLLoader.load(file);
    ...
    private void displayAboutAlert() {
        ...
        alert.setHeaderText("Dusenberry XML DOM Parser");
        alert.setContentText("This application was developed by Dale Musser for CS4330 at the University of Missouri. This specific one was then altered by Jonathan Dusenberry for his DOM assignment.");
